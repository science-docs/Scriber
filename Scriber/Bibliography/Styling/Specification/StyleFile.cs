...
namespace Scriber.Bibliography.Styling.Specification
{
    ...
    /// </summary>
    [XmlRoot("style", Namespace = NAMESPACE_URI)]
    public class StyleFile : File, IGlobalOptions, INamesOptions, INameOptions
    {
        ...
        /// </summary>
        [XmlAttribute("class")]
        public CitationClass CitationClass
        {
            get;
            set;
        }
        ...
        public MacroElement? FindMacro(string name)
        {
            return Macros.FirstOrDefault(e => e.Name == name);
        }
