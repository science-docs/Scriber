...
namespace Scriber.Bibliography.Styling.Specification
{
    ...
    public class TextElement : FormattingElement, IStripPeriods
    {
        ...
        public override void EvaluateOverride(Interpreter interpreter)
        {
            ...
            if (count != 1)
            {
                throw new Exception("Only one of the attributes 'variable', 'value', 'macro' and 'term' is allowed.");
            }
            ...
            {
                var macro = interpreter.StyleFile.FindMacro(Macro);
