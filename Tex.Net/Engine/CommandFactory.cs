    ...
    public static class CommandFactory
    {
        ...
        private static CommandExecution CreateDelegate(string command, MethodInfo method, out ParameterInfo[] parameters)
        {
            ...
            object InvokeDynamic(CompilerState state, object[] args)
            {
                ...
                MatchArguments(state, sorted, param);
        ...
        /// <param name="args"></param>
        /// <param name="parameters"></param>
        private static void MatchArguments(CompilerState state, object[] args, ParameterInfo[] parameters)
        {
        ...
        private static bool IsAssignableFrom(CompilerState state, Type target, object obj, out object transformed)
        {
